# -*- coding: utf-8 -*-
"""
Created on Wed Oct 25 13:56:26 2017
...
def deneme():
    ...
    a=1
    while a<0 or a>0:
        a = int(input("bir sayı giriniz çıkmak için 0:"))
        top=top+a
    print(top)
#%%
""" 
